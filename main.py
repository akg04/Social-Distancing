...
if __name__== "__main__":
    ...
    parser.add_argument('-v', '--video_path', action='store', dest='video_path', default='D:/ML-main/data/example.mp4' ,
                    help='Path for input video')
                    
    parser.add_argument('-o', '--output_dir', action='store', dest='output_dir', default='D:/ML-main/output' ,
                    help='Path for Output images')

    parser.add_argument('-O', '--output_vid', action='store', dest='output_vid', default='D:/ML-main/output_vid/' ,
                    help='Path for Output videos')

    parser.add_argument('-m', '--model', action='store', dest='model', default='D:/ML-main/models/',
